...
async function handler(req, res) {
    ...
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["query"])('INSERT INTO users (email, password_hash, name) VALUES ($1, $2, $3) RETURNING id, email, name', [
            email,
            hashed,
            name || email.split('@')[0]
        ]);
        const user = result.rows[0];
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$js__$5b$api$5d$__$28$ecmascript$29$__["sign"])({
            id: user.id,
            email
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5ae8c445._.js.map