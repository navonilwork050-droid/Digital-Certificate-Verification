...
"[project]/pages/api/issuer/index.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$js__$5b$api$5d$__$28$ecmascript$29$__["verify"])(token);
        req.user = user;
    } catch (err) {
    ...
    if (req.method === 'GET') {
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["query"])('SELECT id, name, email, institution FROM issuers ORDER BY created_at DESC');
    ...
    if (req.method === 'POST') {
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["query"])('INSERT INTO issuers (name, email, institution) VALUES ($1, $2, $3) RETURNING id, name, email, institution', [
                name,
                email,
                institution
            ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__18520c77._.js.map