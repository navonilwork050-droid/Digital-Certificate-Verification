...
"[project]/Desktop/pro/backend/lib/auth.js [api] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pro$2f$backend$2f$lib$2f$auth$2e$js__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/pro/backend/lib/auth.js [api] (ecmascript)");
;
;
const sampleIssuers = [
    {
...
async function handler(req, res) {
    ...
    if (req.method === 'GET') return res.status(200).json(sampleIssuers);
    res.status(405).end();
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__8b80fe31._.js.map