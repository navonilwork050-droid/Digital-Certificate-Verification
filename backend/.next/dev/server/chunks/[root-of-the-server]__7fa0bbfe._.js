...
async function handler(req, res) {
    ...
    if (req.method === 'GET') {
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pro$2f$backend$2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["query"])('SELECT id, holder, certificate_title, issue_date, verified FROM verifications ORDER BY created_at DESC');
    ...
    if (req.method === 'POST') {
        ...
        if (!holder) return res.status(400).json({
            error: 'Holder required'
        });
        try {
            const id = Math.random().toString(36).substr(2, 9);
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$pro$2f$backend$2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["query"])('INSERT INTO verifications (id, holder, certificate_title, issue_date, verified) VALUES ($1, $2, $3, $4, $5) RETURNING id, holder, certificate_title, issue_date, verified', [
                id,
                holder,
                certificate_title,
                issue_date,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7fa0bbfe._.js.map